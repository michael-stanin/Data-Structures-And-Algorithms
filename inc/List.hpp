...
private:
	...
	// Ban copy (or Deep-copy by cloning each node later)
...
public:
	...
	void RemoveHead()
	{
		...
		// Save pointer to headd's next node, before removing current head;
		// basically, head's next node will beocem the *new* head
